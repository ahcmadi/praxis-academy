...
public class groceryStore {
	 ...
	 * 
	 * @author achmadi
	 * @description : Class General For Plant Model 
	 */
    static class Plant {
        private String name;
	 ...
	 * 
	 * @author achmadi
	 * @description : Class General For Fruit Type 
	 */
	 ...
	 * 
	 * @author achmadi
	 * @description : Class Apple For Fuit Type  
	 */
     ...
     * 
     * @param args
     * @description : Method void for Runner Object groceryStore
     */
     ...
     * @param fruitsBasket
     * @return void 
     * @description : method for add new Fruit to FruitBasket List
     */
